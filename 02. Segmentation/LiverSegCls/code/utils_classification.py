...
def best_load(ckpt_dir, net, optim):
    ...
    print('%s/%s' % (ckpt_dir, best_model_name ))
...
class EarlyStopping_CV:
    ...
    def __call__(self, ckpt_dir,result_dir,val_loss, net, optim, fold):

        score = -val_loss

        if self.best_score is None:
            self.best_score = score
            self.save_checkpoint(ckpt_dir,val_loss, net,optim, fold)
    ...
    def save_checkpoint(self, ckpt_dir,val_loss, net ,optim,  fold):
